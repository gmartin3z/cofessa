...
@section('title')
  Crear sección enlaces de interés
@stop
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span12 aligncenter">
          <h3 class="title">Crear sección <strong>enlaces de interés</strong></h3>
          <form action="{{ route('inicio.administrar.guardar_seccion_enlaces') }}" method="post" id="frm_menu_enlaces">
            {{ csrf_field() }}
